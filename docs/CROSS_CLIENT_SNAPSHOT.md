...
| teku | develop | `c5825d53325cd67ab91b35cc544a7b660be317ff` | 10/10 |
| lodestar | v0.39.0-3198-g549b4c390c | `549b4c390cd5bb6d2bb35c48f59e7a04575ba496` | 10/10 |
...
## Final 10-epoch run (all four working engines)

```
scripts/cross-client/diff.py nimbus teku lodestar grandine
wrote results/cross-client/per-slot.csv (1280 engine-slot rows over 320 unique slots)
wrote results/cross-client/divergences.csv (320 divergent slots of 320; 0 had a missing engine row)
...
4 engines × 10 epochs × 32 slots = 1280 records. 0 missing rows. Rock-solid agreement on chain-structure columns (block_root, head_root, source_block_slot, has_block, is_epoch_boundary, is_missed_slot). FCR-output disagreements are dominated by Grandine's anchor-pinning issue (documented on PR #6).
